            ...
            <li style="display:block;">
              <table cellpadding="0" cellspacing="0" class="form-contact myformtable"
                ...
                <tr>
                  ...
                  <th>確認密碼 *:</th>
                  <td><input type="text" reg="empty" class="input-sytle-1" id="J_myform_pass_compare"/></td>
                </tr>
                  </tr>
                
                
                  <th>姓 *:</th>
                  <td><input type="text" reg="empty" class="input-sytle-1" id="J_myform_firstname"/></td>
                </tr>
                  </tr>
                
                
                  <th>名 *:</th>
                  <td><input type="text" reg="empty" class="input-sytle-1" id="J_myform_lastname"/></td>
                </tr>
                  </tr>
                  ...
                  <th>地區 *:</th>
                  <td><input type="text" class="input-sytle-1" reg="empty" id="J_myform_city" /></td>
                </tr>
                  </tr>
                
                
                  <th>住宅地址 *:</th>
                  <td><input type="text" class="input-sytle-1" reg="empty" id="J_myform_address"/></td>
                </tr>
                  </tr>
                
                
                  <th><br/>
                    <a href="javascript:;" class="comm-btn" id="J_userreg_submit">更新</a></th>
                  <td class="gbt"></td>
                </tr>
              </table>
            </li>
    ...
    $.ajax({type:'POST',url:'ajax_reg.php',data:{
        ...
        switch(e)
        {
            case 'wrong1':
                ...
                $('#J_userreg_submit').click(function(){formsubmit_login();});
                break;
            case 'wrong2':
                alert('error!');
                $('#J_userreg_submit').click(function(){formsubmit_login();});
